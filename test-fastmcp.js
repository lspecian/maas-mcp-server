 ...
 * 
 * This script tests the listMachines tool using the FastMCP server.
 */

import fetch from 'node-fetch';

// Configuration
const port = 3002; // Use port 3002 to match the mcp.json configuration

async function testListMachines() {
  try {
    console.log('FastMCP Server - Test listMachines Tool');
    console.log('========================================');
    ...
    if (data.result) {
      try {
        ...
        console.log(`\nTotal machines: ${resultObj.count}`);
      } catch (e) {
        console.log('\nCould not parse result as JSON');
      }
    }
