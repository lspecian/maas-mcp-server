...
function registerDeleteMachineTool(server, maasClient) {
    server.tool("deleteMachine", deleteMachineSchema.shape, async (params) => {
        ...
        try {
            ...
            if (error.name === 'ValidationError') {
                ...
                throw new MaasServerError('Failed to delete machine: ' + error.message, ErrorType.INTERNAL, { originalError: error.message });
            }
        }
    });
}
