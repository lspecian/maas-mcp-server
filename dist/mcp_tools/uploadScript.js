...
const { createDerivedSignal, onAbort, throwIfAborted, isAbortError, handleAbortError } = require('../utils/abortSignalUtils');
...
function registerUploadScriptTool(server, maasClient) {
    server.tool("uploadScript", uploadScriptSchema.shape, async (params, signal) => {
