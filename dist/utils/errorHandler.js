...
exports.MaasApiError = exports.MaasServerError = exports.ErrorType = void 0;
exports.handleValidationError = handleValidationError;
exports.handleMaasApiError = handleMaasApiError;
exports.errorToMcpResult = errorToMcpResult;
...
class MaasServerError extends Error {
    // Add type declarations for the properties
    type;
    details;
    timestamp;
    constructor(message, type = exports.ErrorType.UNKNOWN, details = {}) {
        super(message);
...
exports.MaasServerError = MaasServerError;
/**
...
function handleValidationError(error) {
    logger_js_1.default.error({ error }, 'Validation error occurred');
    // Extract validation details if available (e.g., from zod)
    const details = error.errors || error.issues || {};
    return new MaasServerError('Validation failed: ' + error.message, exports.ErrorType.VALIDATION, details);
}
/**
...
function handleMaasApiError(error) {
    logger_js_1.default.error({ error }, 'MAAS API error occurred');
    ...
    return new MaasServerError('MAAS API error: ' + error.message, exports.ErrorType.MAAS_API, details);
}
/**
...
function errorToMcpResult(error) {
    ...
    logger_js_1.default.error({ error }, 'Converting error to MCP result');
    return {
        success: false,
        error: {
...
// For backward compatibility with code that might still use MaasApiError
class MaasApiError extends MaasServerError {
    constructor(message, statusCode, details = {}) {
        // If statusCode is provided, include it in the details
        const errorDetails = statusCode ? { ...details, statusCode } : details;
        super(message, exports.ErrorType.MAAS_API, errorDetails);
