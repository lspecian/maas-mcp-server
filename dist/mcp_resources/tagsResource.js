...
const { z } = require('zod');
const { TAGS_LIST_URI_PATTERN, TAG_DETAILS_URI_PATTERN, TAG_MACHINES_URI_PATTERN, MaasTagSchema, GetTagParamsSchema, GetTagMachinesParamsSchema } = require('./schemas/tagResourcesSchema');
...
function registerTagsResource(server, client) {
    ...
    server.resource(tagsListResource);
    server.resource(tagDetailsResource);
    server.resource(tagMachinesResource);
