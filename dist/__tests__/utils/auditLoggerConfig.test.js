...
class MockStream extends stream_1.Writable {
    chunks = [];
...
describe('Audit Logger Configuration', () => {
    ...
    describe('Log Level Configuration', () => {
        it('should use default log level from config', async () => {
            ...
            auditLogger.logResourceAccess('machine', '123', 'view', 'req-123', 'user-456', '192.168.1.1');
        ...
        it('should log at different levels based on event type', async () => {
            ...
            auditLogger.logResourceAccessFailure('machine', '123', 'view', 'req-123', new Error('Access denied'), 'user-456', '192.168.1.1');
    ...
    describe('Resource State Inclusion', () => {
        it('should not include resource state by default', async () => {
            ...
            auditLogger.logResourceAccess('machine', '123', 'view', 'req-123', 'user-456', '192.168.1.1', { detail: 'test' }, resourceState);
        ...
        it('should include resource state for both before and after states in modification events', async () => {
            ...
            auditLogger.logResourceModification('machine', '123', 'update', 'req-123', beforeState, afterState, 'user-456', '192.168.1.1');
    ...
    describe('Edge Cases', () => {
        ...
        it('should handle null or undefined resource states gracefully', async () => {
            ...
            auditLogger.logResourceModification('machine', '123', 'update', 'req-123', null, // beforeState
            undefined, // afterState
            'user-456', '192.168.1.1');
