...
exports.restoreRealTimers = restoreRealTimers;
...
exports.waitForMockCalls = waitForMockCalls;
exports.createSyncPoint = createSyncPoint;
exports.createDelayedMock = createDelayedMock;
exports.createSequentialMock = createSequentialMock;
exports.createControlledMock = createControlledMock;
/**
 ...
 */
function waitForMockCalls(mockFn, callCount, timeout = 5000) {
    return waitForCondition(() => mockFn.mock.calls.length >= callCount, timeout);
}
/**
 ...
 */
function createDelayedMock(result, delay = 10) {
 ...
 * expect(await mockApi()).toEqual({ status: 'complete' });
 */
function createSequentialMock(results) {
    let callCount = 0;
    return globals_1.jest.fn().mockImplementation(() => {
