...
const deployMachineWithProgress_js_1 = require("../../mcp_tools/deployMachineWithProgress.js");
...
describe('deployMachineWithProgress', () => {
    ...
    beforeEach(() => {
        ...
        // Register the tool
        (0, deployMachineWithProgress_js_1.registerDeployMachineWithProgressTool)(mockServer, mockMaasClient);
        // Capture the tool callback
        mockToolCallback = mockServer.tool.mock.calls[0][2];
    });
    it('should register the tool with the MCP server', () => {
        expect(mockServer.tool).toHaveBeenCalledWith('maas_deploy_machine_with_progress', expect.any(Object), expect.any(Function));
    });
