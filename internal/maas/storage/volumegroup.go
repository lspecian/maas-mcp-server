...
func (v *volumeGroupClient) CreateVolumeGroup(systemID string, params models.VolumeGroupParams) (*models.VolumeGroup, error) {
...
// Placeholder implementation.
func (v *volumeGroupClient) GetVolumeGroup(systemID string, volumeGroupID int) (*models.VolumeGroup, error) {
...
// Placeholder implementation.
func (v *volumeGroupClient) ListVolumeGroups(systemID string) ([]models.VolumeGroup, error) {
...
// Placeholder implementation.
func (v *volumeGroupClient) CreateLogicalVolume(systemID string, volumeGroupID int, params models.LogicalVolumeParams) (*models.LogicalVolume, error) {
...
// Placeholder implementation.
func (v *volumeGroupClient) ResizeLogicalVolume(systemID string, volumeGroupID, logicalVolumeID int, newSize int64) (*models.LogicalVolume, error) {
...
// Placeholder implementation.
func (v *volumeGroupClient) GetLogicalVolume(systemID string, volumeGroupID, logicalVolumeID int) (*models.LogicalVolume, error) {
