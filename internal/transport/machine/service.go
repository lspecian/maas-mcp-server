...
type Service interface {
	...
	ListMachines(ctx context.Context, filters map[string]string) ([]types.MachineContext, error)

	// GetMachine retrieves a specific machine by ID
	GetMachine(ctx context.Context, id string) (*types.MachineContext, error)
	...
	AllocateMachine(ctx context.Context, constraints map[string]string) (*types.MachineContext, error)

	// DeployMachine deploys a machine with specified OS and configuration
	DeployMachine(ctx context.Context, id string, osConfig map[string]string) (*types.MachineContext, error)
	...
	PowerOnMachine(ctx context.Context, id string) (*types.MachineContext, error)

	// PowerOffMachine powers off a machine
	PowerOffMachine(ctx context.Context, id string) (*types.MachineContext, error)
}
