...
type Repository interface {
	...
	ListMachines(ctx context.Context, filters map[string]string) ([]models.Machine, error)

	// GetMachine retrieves details for a specific machine
	GetMachine(ctx context.Context, systemID string) (*models.Machine, error)

	// AllocateMachine allocates a machine based on constraints
	AllocateMachine(ctx context.Context, params *entity.MachineAllocateParams) (*models.Machine, error)

	// DeployMachine deploys an allocated machine
	DeployMachine(ctx context.Context, systemID string, params *entity.MachineDeployParams) (*models.Machine, error)
	...
	PowerOnMachine(ctx context.Context, systemID string) (*models.Machine, error)

	// PowerOffMachine powers off a machine
	PowerOffMachine(ctx context.Context, systemID string) (*models.Machine, error)
}
