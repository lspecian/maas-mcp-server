/**
 * Comprehensive Tests for Resource Handler Error Handling
 * 
 * This file provides comprehensive tests for error handling in all resource handlers,
...
describe('Comprehensive Resource Handler Error Handling', () => {
  ...
  describe('Content Negotiation Error Handling', () => {
    ...
    it('should handle XML format request gracefully', async () => {
      ...
      // Execute with XML Accept header
      const result = await detailsCallback(
        resourceDetailsUri,
        { resource_id: 'test-resource' },
        { signal: new AbortController().signal }
      ...
      // Should still return JSON (default format)
    ...
    it('should fall back to JSON for unsupported formats', async () => {
      ...
      // Execute with unsupported Accept header
      const result = await detailsCallback(
        resourceDetailsUri,
        { resource_id: 'test-resource' },
        { signal: new AbortController().signal }
