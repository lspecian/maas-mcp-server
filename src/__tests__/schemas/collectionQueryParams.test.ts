...
import {
  ...
  // Assuming common types like OrderDirection might be defined in the imported file or zod itself
} from '../../mcp_resources/schemas/collectionQueryParams.js';

describe('BaseCollectionQueryParamsSchema', () => {
  const schema = BaseCollectionQueryParamsSchema;
...
describe('MachineCollectionQueryParamsSchema', () => {
  const schema = MachineCollectionQueryParamsSchema;
  ...
  test('should handle unknown parameters (strip)', () => {
    ...
    if (result.success) {
      ...
      expect((result.data as any).unknownMachineParam).toBeUndefined();
    }
  });
});

describe('SubnetCollectionQueryParamsSchema', () => {
  const schema = SubnetCollectionQueryParamsSchema;
...
describe('ZoneCollectionQueryParamsSchema', () => {
  const schema = ZoneCollectionQueryParamsSchema;
...
describe('DeviceCollectionQueryParamsSchema', () => {
  const schema = DeviceCollectionQueryParamsSchema;
...
describe('DomainCollectionQueryParamsSchema', () => {
  const schema = DomainCollectionQueryParamsSchema;
...
describe('TagCollectionQueryParamsSchema', () => {
  const schema = TagCollectionQueryParamsSchema;
