  ...
  server.registerTool({
    ...
    execute: async (params) => {
      ...
      try {
        ...
        if (params.name) apiParams.hostname = params.name;
        if (params.system_id) apiParams.system_id = params.system_id;
        if (params.zone) apiParams.zone = params.zone;
        if (params.pool) apiParams.pool = params.pool;
        if (params.cpu_count) apiParams.cpu_count = params.cpu_count;
        if (params.memory) apiParams.memory = params.memory;
