  ...
  server.registerTool({
    ...
    execute: async (params) => {
      ...
      try {
        ...
        if (params.kernel_opts) apiParams.kernel_opts = params.kernel_opts;
        if (params.definition) apiParams.definition = params.definition;
  ...
  server.registerTool({
    ...
    execute: async (params) => {
      ...
      try {
        ...
        if (params.new_name) apiParams.name = params.new_name;
        if (params.comment) apiParams.comment = params.comment;
        if (params.kernel_opts) apiParams.kernel_opts = params.kernel_opts;
        if (params.definition) apiParams.definition = params.definition;
