...
describe('Network Configuration Features', () => {
  ...
  describe('Subnet Management', () => {
    it('should list all subnets', async () => {
      ...
      const response = await testEnv.request
        .post('/mcp')
        .send(createToolCallRequest('maas_list_subnets', {}));
    ...
    it('should create a subnet', async () => {
      ...
      const response = await testEnv.request
        .post('/mcp')
        .send(createToolCallRequest('maas_create_subnet', {
  ...
  describe('DHCP Management', () => {
    it('should enable DHCP on a VLAN', async () => {
      ...
      const response = await testEnv.request
        .post('/mcp')
        .send(createToolCallRequest('maas_enable_dhcp', {
          vlan_id: 1,
  ...
  describe('Interface Management', () => {
    ...
    it('should configure a machine interface', async () => {
      ...
      const response = await testEnv.request
        .post('/mcp')
        .send(createToolCallRequest('maas_configure_interface', {
          system_id: 'abc123',
          interface_id: 1,
          mode: 'static',
  ...
  describe('Space Management', () => {
    ...
    it('should create a space', async () => {
      ...
      const response = await testEnv.request
        .post('/mcp')
        .send(createToolCallRequest('maas_create_space', {
          name: 'test-space',
